...
def main():
    """The evaluator."""
    ref_file = 'data/keypoint_annotations_example.json' # str, help='annotation json file', default='keypoint_annotations_example.json'
    sub_file = 'data/keypoint_predictions_example.json' # str, help='prediction json file', default='keypoint_predictions_example.json'
